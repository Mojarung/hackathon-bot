...
ровно как раньше. Настройка по шагам — [docs/google-calendar.md](docs/google-calendar.md).
...
Модель может не выбрать ничего — на «созвон в 15:00» реакции не будет, и в этом
смысл.
